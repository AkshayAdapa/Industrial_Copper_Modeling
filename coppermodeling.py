...
# Image and title in the middle of the interface
st.markdown("""
<style>
    .center {
        display: flex;
...
st.markdown("""
<div class="center">
    <img src="https://image.slidesdocs.com/responsive-images/background/illustrated-3d-model-of-copper-tubing-for-industrial-use-powerpoint-background_327956c93f__960_540.jpg" style="width: 50%;" alt="Copper Tubing Image">
</div>

<div style='text-align:center'>
    <h1 style='color:#009999;'>Industrial Copper Modeling Application</h1>
    <h3 style='position:absolute; right:10px;'>Akshay Kumar</h3>
</div>
""", unsafe_allow_html=True)
...
#Home Section
with tab1:
    st.write("**Project Title:** Industrial Copper Modeling")
    st.write("**Skills take away From This Project:** Python scripting, Data Preprocessing, EDA, Streamlit")
    st.write("**Domain:** Manufacturing")
...
with tab2:    
    # Form for predicting selling price
...
# Add footer
st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Akshay kumar Adapa</h6>', unsafe_allow_html=True )  
